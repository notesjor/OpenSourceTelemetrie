...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl='urn:schemas-microsoft-com:xslt'>
    ...
    <xsl:template match="MigrationLog">
        <html>
            <head>
                ...
                <script language="javascript">
                  ...
                  {
                  uMe.src = "_Migration_Files/MigrationReport_Minus.gif"
                  }
                  else
                  {
                  uMe.src = "_Migration_Files/MigrationReport_Plus.gif"
                  }
                  }
                </script>
            </head>
                    ...
                    <Events>
                        <xsl:for-each select="Event">
                            ...
                            <Event>
                                ...
                                <xsl:attribute name="Solution"><xsl:value-of select="/MigrationLog/Properties/Property[@Name='Solution']/@Value"/> </xsl:attribute> 
